 ...
 * Version: 1.1.0 Copyright (C)
 * 14 August 2017, Zhihai Wang: Copyright (C) 
 * 12 August 2011, Zhihai Wang: Copyright (C) 
 * 31 January 2001, Zhihai Wang: Copyright (C) 
 * 
 * NB. This is a simple version the TAN, which is implemented on the 
 *     platform Weka-3-8-1 (64 bits). 
 */
...
// the most essential classes in the Weka
import weka.core.Attribute;
import weka.core.Instance;
import weka.core.Instances;

// Here: transfer a double into a string
import weka.core.Utils;

// show the quotation of the references
...
/**
 * <!-- globalinfo-start --> 
 * Class for building and using a simple Tree Augmented Naive Bayes (TAN1)
 * classifier. This method outperforms naive Bayes, yet at the same time 
 * maintains the computational simplicity (no search involved) and 
 * robustness that characterizes naive Bayes.<br/>
 * <br/>
 * There is no any running parameter in this simple version. <br/>
 * (1) For any probability, using Laplace estimation. This is different 
 *     from the original paper.<br/>
 * (2) Any training instance with missing value can be processed in this 
 *     program. We do not delete any instance with any missing value.<br/> 
 * (3) The first attribute is always chosen as the root node for building 
 *     the maximum spanning tree.<br/>  
 * 
 * <br/>
 ...
 * Networks. In: Proceedings of the Thirteenth National Conference on
 * Artificial Intelligence (AAAI 1996), 1996. pp. 1277 -1284.<br/>
 * 
 * <br/>
 * Friedman, N., Geiger, D., and Goldszmidt, M. Bayesian network
 * classifiers. Machine Learning, Volume 29, Number 2-3, 1997. pp. 131-163.
 * <br/>
 * <p/>
 * <!-- globalinfo-end -->
 *
 ...
 * 
 * @author Zhihai Wang (zhhwang@bjtu.edu.cn)
 * @version $Revision: 1.1.0 $ <br/>
 *          Copyright (C) 14 August 2017, Zhihai Wang <br/>
 */

/*
 * 12 August 2011, Zhihai Wang: 
 * All classifiers extends AbstractClassifier.java in the Weka-3-8-1
 * and AbstractClassifier.java implements the following five interfaces:
 *   (1) Cloneable;
 *   (2) Serializable;
 *   (3) OptionHandler;
 ...
 *   (5) RevisionHandler.
 */
public class TAN1A extends AbstractClassifier 
  implements TechnicalInformationHandler {
	...
	/* Running Methods:
	 * (1) Eclipse:
	 *     Main Class: weka.classifiers.bayes.TAN.TAN1A
	 *     Program Arguments: -output-debug-info
	 *               -t D:\Datasets2017A\datasets0\weather.nominal.arff
	 *                -x 3 -s 11
	 *     
	 * (2) DOS Method:
	 *     D:\Weka381B\Weka-3-8-1B\bin>java -Djava.ext.dirs=
	 *        D:\Weka381B\Weka-3-8-1B\libs 
	 *        weka.classifiers.bayes.TAN.TAN1A 
	 *        -t D:\Datasets2017A\datasets0\weather.nominal.arff
	 *        -output-debug-info
	 *        -x 3
	 *        
	 * (3) DOS Batch Processing:
	 *     D:\Weka381B\Weka-3-8-1B\bin>for /r D:\Datasets2017A\datasets1 
	 *     %j in (*.arff) do for /l %i in (1,1,3) 
	 *     do java -Djava.ext.dirs=
	 *     D:\Weka381B\Weka-3-8-1B\libs weka.classifiers.bayes.NaiveBayes 
	 *     -t %j  -x 3 -s %i -d D:\Datasets2017A\results.txt
	 */
